(function() {
  ...
  style.textContent = [
    ...
    '  background: #3f54d4; border: none; cursor: pointer;',
    '  box-shadow: 0 8px 30px rgba(63, 84, 212, 0.25);',
    '  display: flex; align-items: center; justify-content: center;',
    '  transition: transform 0.2s ease, background 0.2s ease;',
    '  pointer-events: auto; z-index: 999999;',
    '  line-height: 1; text-indent: 0; letter-spacing: normal;',
    '}',
    '.gbz-toggle:hover { transform: scale(1.08); background: #3344b0; }',
    ...
    '  border-radius: 16px; box-shadow: 0 8px 30px rgba(63, 84, 212, 0.25);',
    ...
    '}',
    '.gbz-header {',
    '  background: #3f54d4; color: #ffffff;',
    ...
    '.gbz-messages::-webkit-scrollbar-thumb { background: rgba(63, 84, 212, 0.2); border-radius: 10px; }',
    '.gbz-msg {',
    '  max-width: 82%; padding: 10px 14px; border-radius: 14px;',
    '  word-wrap: break-word; white-space: pre-wrap;',
    '  animation: gbzFadeIn 0.2s ease;',
    '}',
    '.gbz-msg a { color: #3f54d4; text-decoration: underline; word-break: break-all; }',
    '@keyframes gbzFadeIn {',
    ...
    '}',
    '.gbz-msg.gbz-user {',
    '  align-self: flex-end; background: #3f54d4;',
